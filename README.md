...
(Para conocer mas acerca de este proyecto revisar la [memoria]([src/main.py](https://github.com/amargon18/Web-application-for-holiday-management/blob/main/CGIS%20(1).pdf))
